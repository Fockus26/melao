...
| D002 | Colores | Dorado #B8913A solo decorativo en claro; texto gold.700/800, gráficos gold.600 | `decisions/01-colores.md` | Pendiente |
...
| D007 | Colores | Dark mode completo desde v1; la práctica siempre en modo escenario | `decisions/01-colores.md` | Pendiente |
| D008 | Tipografía | Fraunces en titulares, Geist Sans (cifras tabulares) en UI y cuentas | `decisions/02-tipografia.md` | Pendiente |
